        ...
        (function (Test) {
            ...
            QUnit.test('RoleDialog Edit Permissions Button', function (assert) {
                ...
                try {
                    ...
                    ajax_5.addServiceHandler("~/services/Administration/RolePermission/List", function (s) {
        ...
        (function (Test) {
            ...
            QUnit.test('RoleDialog New Entity, Apply Changes Button', function (assert) {
                ...
                try {
                    ...
                    var createCalls = 0;
                    ajax_6.addServiceHandler("~/services/Administration/Role/Create", function (s) {
                        createCalls++;
                        assert.deepEqual(s.request, {
                            Entity: {
                                RoleName: 'ABC  '
                        ...
                        var retrieveCalls = 0;
                        ajax_6.addServiceHandler("~/services/Administration/Role/Retrieve", function (s) {
                            retrieveCalls++;
                            assert.deepEqual(s.request, { EntityId: 9876 }, 'retrieve request');
                            setTimeout(function () {
                                try {
        ...
        (function (Test) {
            ...
            QUnit.test('RoleDialog New Entity, Save and Close Button', function (assert) {
                ...
                try {
                    ...
                    var createCalls = 0;
                    ajax_7.addServiceHandler("~/services/Administration/Role/Create", function (s) {
                        createCalls++;
                        assert.deepEqual(s.request, {
                            Entity: {
                                RoleName: 'ABC  '
                        ...
                        var retrieveCalls = 0;
                        ajax_7.addServiceHandler("~/services/Administration/Role/Retrieve", function (s) {
                            throw new Error("retrieve shouldn't be called!");
                        });
                        setTimeout(function () {
                            try {
        ...
        (function (Test) {
            ...
            QUnit.test('LanguageDialog New Entity, Apply Changes Button', function (assert) {
                ...
                try {
                    ...
                    var createCalls = 0;
                    ajax_8.addServiceHandler("~/services/Administration/Language/Create", function (s) {
                        createCalls++;
                        assert.deepEqual(s.request, {
                            Entity: {
                                LanguageId: 'tr  ',
                        ...
                        var retrieveCalls = 0;
                        ajax_8.addServiceHandler("~/services/Administration/Language/Retrieve", function (s) {
                            retrieveCalls++;
                            assert.deepEqual(s.request, { EntityId: 9876 }, 'retrieve request');
                            setTimeout(function () {
                                try {
        ...
        (function (Test) {
            ...
            QUnit.test('LanguageDialog New Entity, Save and Close Button', function (assert) {
                ...
                try {
                    ...
                    var createCalls = 0;
                    ajax_9.addServiceHandler("~/services/Administration/Language/Create", function (s) {
                        createCalls++;
                        assert.deepEqual(s.request, {
                            Entity: {
                                LanguageId: 'tr  ',
                        ...
                        var retrieveCalls = 0;
                        ajax_9.addServiceHandler("~/services/Administration/Language/Retrieve", function (s) {
                            throw new Error("retrieve shouldn't be called!");
                        });
                        setTimeout(function () {
                            try {
