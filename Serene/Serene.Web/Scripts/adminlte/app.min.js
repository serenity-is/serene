...
void 0!==t&&t.height()>n&&$(".content-wrapper, .right-side").css("min-height",t.height())}},fixSidebar:function(){if(!$("body").hasClass("fixed"))return void(void 0!==$.fn.slimScroll&&$(".sidebar").slimScroll({destroy:!0}).height("auto"))
if(void 0===$.fn.slimScroll&&window.console&&window.console.error("Error: the fixed layout requires the slimscroll plugin!"),$.AdminLTE.options.sidebarSlimScroll&&void 0!==$.fn.slimScroll)if($(".slimScrollDiv").length){var e=$(window).height()-$(".main-header").height()+"px"
$(".slimScrollDiv").css("height",e),$(".slimScrollDiv").children().css("height",e)}else $(".sidebar").slimScroll({destroy:!0}).height("auto"),$(".sidebar").slimscroll({height:$(window).height()-$(".main-header").height()+"px",color:"rgba(0,0,0,0.2)",size:"3px"})
window.setTimeout(function(){$(window).triggerHandler("layout")},500)}},$.AdminLTE.pushMenu={activate:function(e){var i=$.AdminLTE.options.screenSizes
