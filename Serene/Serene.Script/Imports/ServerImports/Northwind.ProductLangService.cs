...
namespace Serene.Northwind
{
    ...
    public partial class ProductLangService
    {
        ...
        public static jQueryXmlHttpRequest Create(SaveRequest<ProductLangRow> request, Action<SaveResponse> onSuccess = null, ServiceCallOptions options = null)
        {
            return null;
        }

        [InlineCode("Q.serviceRequest('Northwind/ProductLang/Update', {request}, {onSuccess}, {options})")]
        public static jQueryXmlHttpRequest Update(SaveRequest<ProductLangRow> request, Action<SaveResponse> onSuccess = null, ServiceCallOptions options = null)
        {
            return null;
        }
        ...
        public static jQueryXmlHttpRequest Retrieve(RetrieveRequest request, Action<RetrieveResponse<ProductLangRow>> onSuccess = null, ServiceCallOptions options = null)
        {
            return null;
        }
